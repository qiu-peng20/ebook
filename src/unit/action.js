const actions = {
	...
	setTitleShow:({commit},titleShow)=>{
		return commit('SET_TITLESHOW',titleShow)
	},
	setSizeShow:({commit},sizeShow)=>{
		return commit('SET_SIZESHOW',sizeShow)
	},
	...
	setShelfSelected({ commit }, selectes) {
	  return commit('SET_SHELF_SELECTED', selectes)
	},
